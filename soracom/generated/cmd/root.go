...
var providedAuthCommand string
var rawOutput bool
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&providedAuthCommand, "auth-command", "", "Specify AuthCommand to be used for authentication. If this option is specified, soracom-cli works without profiles. It means you don't need to run 'soracom configure' before running the command. This may be suitable for temporary execution. Please don't forget specifying these options along with --coverage-type.")
