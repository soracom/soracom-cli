...
func InitAllSubCommands() {
	InitAnalysisQueriesGetCmd()
	InitAnalysisQueriesStartCmd()
	InitAnalysisSchemasCmd()
	...
	InitBatchGroupsCreateCmd()
	InitBatchGroupsDeleteCmd()
	InitBatchGroupsGetCmd()
	InitBatchGroupsJobsCreateCmd()
	InitBatchGroupsJobsGetCmd()
	InitBatchGroupsJobsListCmd()
	InitBatchGroupsJobsListTasksCmd()
	InitBatchGroupsListCmd()
	InitBatchGroupsUpdateCmd()
	InitBillsExportCmd()
	...
	InitDataGetCmd()
	InitDataGetEntriesByCategoryCmd()
	InitDataGetEntriesCmd()
	InitDataGetEntryCmd()
	InitDataListResourceMetadataCmd()
	...
	InitEuiccsDeleteTagCmd()
	InitEuiccsGetCmd()
	InitEuiccsListCmd()
	InitEuiccsProfileCancelOperationCmd()
	InitEuiccsProfileDownloadProfileViaActivationCodeCmd()
	InitEuiccsProfileGetCmd()
	InitEuiccsProfileListOperationsCmd()
	InitEuiccsProfileOrderCmd()
	InitEuiccsProfileRequestActivateCmd()
	InitEuiccsProfileRequestDeleteCmd()
	InitEuiccsProfileRequestDownloadCmd()
	InitEuiccsProfileTypesListCmd()
	InitEuiccsPutTagsCmd()
	InitEuiccsStatusGetCmd()
	...
	InitPortMappingsCreateForSimCmd()
	...
	InitSimTransferRequestsAddSimsCmd()
	InitSimTransferRequestsCancelCmd()
	InitSimTransferRequestsCreateCmd()
	InitSimTransferRequestsDeleteCmd()
	InitSimTransferRequestsExecuteCmd()
	InitSimTransferRequestsGetCmd()
	InitSimTransferRequestsListCmd()
	InitSimTransferRequestsListSimsCmd()
	InitSimTransferRequestsRejectCmd()
	InitSimTransferRequestsRemoveSimsCmd()
	InitSimTransferRequestsSubmitCmd()
	InitSimTransferRequestsUpdateCmd()
	InitSimsActivateCmd()
	...
	InitSoraCamDevicesAtomCamSettingsGetSelfRebootCmd()
	...
	InitSoraCamDevicesAtomCamSettingsSetSelfRebootCmd()
	...
	InitSoraCamDevicesAtomCamUpdateRealTimeAccessOptionCmd()
