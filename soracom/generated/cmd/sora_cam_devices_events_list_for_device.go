...
func InitSoraCamDevicesEventsListForDeviceCmd() {
	...
	SoraCamDevicesEventsListForDeviceCmd.Flags().Int64Var(&SoraCamDevicesEventsListForDeviceCmdLimit, "limit", 10, TRAPI("Maximum number of events to retrieve in one request (value range is 1 to 100). Note that the response may contain fewer events than the specified limit."))
