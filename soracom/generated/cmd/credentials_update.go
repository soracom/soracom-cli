...
func InitCredentialsUpdateCmd() {
	CredentialsUpdateCmd.Flags().StringVar(&CredentialsUpdateCmdCredentialsId, "credentials-id", "", TRAPI("Credential set ID."))
	...
	CredentialsUpdateCmd.RunE = CredentialsUpdateCmdRunE
