...
func InitUsersPasswordUpdateCmd() {
	...
	UsersPasswordUpdateCmd.Flags().StringVar(&UsersPasswordUpdateCmdOperatorId, "operator-id", "", TRAPI("Operator ID"))
	...
	UsersPasswordUpdateCmd.RunE = UsersPasswordUpdateCmdRunE
...
func collectUsersPasswordUpdateCmdParams(ac *apiClient) (*apiParams, error) {
	...
	if UsersPasswordUpdateCmdOperatorId == "" {
		UsersPasswordUpdateCmdOperatorId = ac.apiCredentials.getOperatorID()
	}
