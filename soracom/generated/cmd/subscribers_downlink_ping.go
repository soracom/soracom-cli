...
func InitSubscribersDownlinkPingCmd() {
	...
	SubscribersDownlinkPingCmd.RunE = SubscribersDownlinkPingCmdRunE
...
func buildBodyForSubscribersDownlinkPingCmd() (string, error) {
	...
	if SubscribersDownlinkPingCmd.Flags().Lookup("number-of-ping-requests").Changed {
		result["numberOfPingRequests"] = SubscribersDownlinkPingCmdNumberOfPingRequests
	}

	if SubscribersDownlinkPingCmd.Flags().Lookup("timeout-seconds").Changed {
