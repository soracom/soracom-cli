...
func InitSoraCamDevicesUpdateExportUsageLimitOverrideCmd() {
	...
	SoraCamDevicesUpdateExportUsageLimitOverrideCmd.RunE = SoraCamDevicesUpdateExportUsageLimitOverrideCmdRunE
...
func buildBodyForSoraCamDevicesUpdateExportUsageLimitOverrideCmd() (string, error) {
	...
	if SoraCamDevicesUpdateExportUsageLimitOverrideCmd.Flags().Lookup("limit-hours").Changed {
