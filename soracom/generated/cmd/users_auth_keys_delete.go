...
func InitUsersAuthKeysDeleteCmd() {
	...
	UsersAuthKeysDeleteCmd.Flags().StringVar(&UsersAuthKeysDeleteCmdOperatorId, "operator-id", "", TRAPI("Operator ID"))

	UsersAuthKeysDeleteCmd.Flags().StringVar(&UsersAuthKeysDeleteCmdUserName, "user-name", "", TRAPI("user_name"))

	UsersAuthKeysDeleteCmd.RunE = UsersAuthKeysDeleteCmdRunE
...
func collectUsersAuthKeysDeleteCmdParams(ac *apiClient) (*apiParams, error) {
	...
	if UsersAuthKeysDeleteCmdOperatorId == "" {
		UsersAuthKeysDeleteCmdOperatorId = ac.apiCredentials.getOperatorID()
	}
